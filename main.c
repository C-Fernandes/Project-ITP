...
int main()
{
  ...
  while (1)
  {
    ...
    do
    {
      ...
      if ((strcmp(action, "TURN") != 0) && (strcmp(action, "DISCARD") != 0))
      {
    ...
    if ((cardTable[0] == 'V' || cardTable[0] == 'C') && (outroJogadorComprou == false))
    {
      ...
      arquivoCartas = addCardFile(hand, NULL, endArqCartas, "a\0", NULL);
    }
    else
    {
